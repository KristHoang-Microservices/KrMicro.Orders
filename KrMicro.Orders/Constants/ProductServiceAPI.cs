...
public static class ProductServiceAPI
{
    ...
    public static readonly string UpdateStock = "/UpdateStockSingle";
    ...
    public static string UpdateStockById(short id, string sizeCode)
    {
        return $"{GetProduct}/{id}/{sizeCode}{UpdateStock}";
    }
}